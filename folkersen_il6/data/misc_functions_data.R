find_proxy <- function(snp, exp_data, out_data) {
  ...
  if (
    query$result[1, 1] %in% c(
      "  error: rs645692 is not a biallelic variant.,",
      "  error: rs201335322 is monoallelic in the CEU population.,",
      "  error: rs201428629 is not in 1000G reference panel.,",
      "  error: rs1136758 is not in 1000G reference panel.,"
    )
  ) {
