...
# 1) Prepare the data --------------------------------------------------
load(here::here("ligthart_crp", "data", "mr_data_pd.rda"))
...
save(
  ...
  primary_pd_r2_001, sensitivity_pd_r2_001,
  primary_pd_r2_01, sensitivity_pd_r2_01,
  file = here::here("ligthart_crp", "analysis", "mr_results_pd.rda")
)
