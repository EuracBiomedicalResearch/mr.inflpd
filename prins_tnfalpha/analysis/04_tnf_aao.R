# MR inflammation: TNF->AAO --------------------------------------------
library(tidyverse)
library(MendelianRandomization)
library(TwoSampleMR)

# 1) Load the data -----------------------------------------------------
load(here::here("prins_tnfalpha", "data", "mr_data_aao.rda"))
...
# 3) Save results ------------------------------------------------------
save(
  primary_aao, sensitivity_aao,
  file = here::here("prins_tnfalpha", "analysis", "mr_results_aao.rda")
)
